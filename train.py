...
def main():
    ...
    # callbacks
    callbacks = [
        pl.callbacks.TQDMProgressBar(),  # pl.callbacks.RichProgressBar(),
    ...
    # Fix for single device strategy
    if isinstance(cfg.DEVICE, (list, tuple)) and len(cfg.DEVICE) > 1:
        ddp_strategy = "ddp"
    else:
        ddp_strategy = "auto"  # Lightning will choose the best single-device strategy
